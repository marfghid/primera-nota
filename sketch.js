const trabajitos = [
    ...
    {
        photo: "https://github.com/marfghid/primera-nota/blob/main/imgs/sillon.webp?raw=true",
        title: "Diseño Residual.",
        description: "Trabajo de Proyecto III, con Prof. Clarisa Menteguiaga."
    },
    {
        photo: "https://github.com/marfghid/primera-nota/blob/main/imgs/IMG_5800.webp?raw=true",
        title: "Figura Animal de Metal; Cisne.",
        description: "Trabajo de Procesos y Peototipos II, con Prof. Patricio Araya."
    },
    {
        photo: "https://github.com/marfghid/primera-nota/blob/main/imgs/lampara%20rene.webp?raw=true",
        title: "Objeto de Luz.",
    ...
    },
   {
     ...
     {
        photo: "https://github.com/marfghid/primera-nota/blob/main/imgs/img%20capsula.webp?raw=true",
        title: "Cápsula del tiempo.",
        description: "Trabajo de Proyecto II, con Prof. Gabriela Pradenas."
    },
 {
        photo: "https://github.com/marfghid/primera-nota/blob/main/imgs/vinilo%20rene.webp?raw=true",
        title: "Vinilo de un Libro.",
        description: "Trabajo de Proyecto I, con Prof. René Perea."
    },      
 {
        photo: "https://github.com/marfghid/primera-nota/blob/main/imgs/IMG_4209.webp?raw=true",
        title: "Diagnóstico Proyecto III.",
        description: "Trabajo de Proyecto III, con Prof. Clarisa Menteguiaga."
    }      
];
...
datos.forEach((x) => {
    if (x.nombre == "María Fernanda García") {
        yo = x;
    } else {
        otrxs.push(x);
    }
